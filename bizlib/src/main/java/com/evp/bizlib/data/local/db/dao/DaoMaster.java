...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        EmvTerminalDao.createTable(db, ifNotExists);
        IssuerDao.createTable(db, ifNotExists);
        SettledTransDataDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        EmvTerminalDao.dropTable(db, ifExists);
        IssuerDao.dropTable(db, ifExists);
        SettledTransDataDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(EmvTerminalDao.class);
        registerDaoClass(IssuerDao.class);
        registerDaoClass(SettledTransDataDao.class);
