...
public class QRPaymentBSCMenuActivity extends BaseActivityWithTickForAction {
    private MenuPage menuPage;
    private WeakReference<QRPaymentBSCMenuActivity> weakReference;

    public QRPaymentBSCMenuActivity() {
    ...
    MenuPage.OnProcessListener onProcessListener = new MenuPage.OnProcessListener() {
        ...
        public void process(String index) {
            QRPaymentBSCMenuActivity activity = weakReference.get();
    ...
    public MenuPage createMenuPage() {
        MenuPage.Builder builder = new MenuPage.Builder(QRPaymentBSCMenuActivity.this, 9, 3);
        ConfigUtils.getInstance().getMenu(builder, ConfigConst.MenuType.QR_BSC_MENU);
