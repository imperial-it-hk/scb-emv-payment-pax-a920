...
public class QRCodeMenuActivity extends BaseActivityWithTickForAction {
    private MenuPage menuPage;
    private WeakReference<QRCodeMenuActivity> weakReference;
    ...
    MenuPage.OnProcessListener onProcessListener = new MenuPage.OnProcessListener() {
        ...
        public void process(int index) {
            QRCodeMenuActivity activity = weakReference.get();
            switch (index) {
                case 0:
    ...
    public MenuPage createMenuPage() {
        MenuPage.Builder builder = new MenuPage.Builder(QRCodeMenuActivity.this, 9, 3)
